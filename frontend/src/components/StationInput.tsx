    ...
    <div className="relative">
      ...
      >
        ...
        <input
          ...
          className={`
            w-full py-3.5 rounded-xl bg-transparent 
        ...
        >
          {suggestions.map((station) => (
            <button
              key={station.id}
              type="button"
              className="w-full px-4 py-3.5 text-left hover:bg-red-50 transition-colors flex items-center gap-3 border-b border-gray-50 last:border-0"
