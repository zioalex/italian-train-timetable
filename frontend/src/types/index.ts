...
export interface Train { id: string; trainNumber: string; category: TrainCategory; categoryDesc: string; operator: Operator; origin: Station; destination: Station; departureTime: string; arrivalTime: string; duration: number; delay?: number; status?: TrainStatus; }
